...
// DB接続情報
$dbn = 'mysql:dbname=application_form;charset=utf8;port=3306;host=localhost';
$user = 'root';
$pwd = '';
...
$sql = 'INSERT INTO
           `application_table`(`id`, `char_sei`, `char_mei`, `kana_sei`, `kana_mei`, `mail`, `affiliation`, `target_for`, `contents`, `problem`, `created_at`, `updated_at`)
           VALUES(NULL, :char_sei, :char_mei,:kana_sei, :kana_mei, :mail, :affiliation, :target_for, :contents, :problem, sysdate(), sysdate())';
