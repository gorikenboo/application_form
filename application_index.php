            ...
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <form class="row g-3" action="application_create.php" method="POST">
                        ...
                        <div class="col-md-12">
                            <label for="validationDefault03" class="form-label">現在感じている問題点(あれば)</label>
